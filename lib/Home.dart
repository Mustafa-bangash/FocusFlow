      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            ...
            },style: ElevatedButton.styleFrom(backgroundColor: Color(0xFF9966FF)), child: Text("Logout",style: TextStyle(color:Colors.white, fontSize: 18, fontWeight:FontWeight.w900),)),
